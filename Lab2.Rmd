...
```
I reused the code from Lab1 and ran them multiple times. I found that around 1000 trials, the means and variances converged to their expected values to provide confidence that the die was loaded.
